...
static const struct verb verbs[] = {
    { "Installing and keeping software", "INSTALL", "install", pkg_install,
      "PACKAGE/M/A,ROOT/K/R,AT/K,CHANNEL/K,VERSION/K,ARCH/K,ACCEPTKEY/K,UNPACKED/K,DOWNGRADE/S,DRYRUN/S" TMPL_ROOTED,
    ...
    { NULL, "UPGRADE", "upgrade", pkg_upgrade,
      "PACKAGE,ALL/S,ROOT/K/R,CHANNEL/K,VERSION/K,ARCH/K,DOWNGRADE/S,ACCEPTKEY/K,UNPACKED/K,DRYRUN/S" TMPL_ROOTED,
      "a package, or ALL of them, to the newest version; with no name and no root, pkg itself" },
    { NULL, "ROLLBACK", "rollback", pkg_rollback,
      "PACKAGE/A,ROOT/K/R,CHANNEL/K,VERSION/K,ARCH/K,ACCEPTKEY/K,DRYRUN/S" TMPL_ROOTED,
    ...
    { NULL, "REPAIR", "repair", pkg_repair,
      "PACKAGE,ALL/S,ROOT/K/R,CHANNEL/K,ARCH/K,UNPACKED/K,DRYRUN/S" TMPL_ROOTED, "put damaged files back" },
