...
How Pkg is built, tested and proven, the container format, the AROS defects
found while testing, and the record of how each part was established. For
using or publishing with Pkg, see the [README](../README.md) and the other
guides in this directory. The step-by-step goals are in [GOAL.md](../GOAL.md)
and the open questions in [OPEN.md](../OPEN.md).
