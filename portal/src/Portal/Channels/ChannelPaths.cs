...
public static partial class ChannelPaths
{
    ...
    static readonly HashSet<string> Reserved = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        "favicon.ico", "error", "health", "_push", "_admin", "index", "get", "downloads", "statistics", "docs", "install", "install.sh", "install.ps1", "get-pkg", "privacy", "see", "account", "signin", "signin-github", "signout", "admin", "report", "trust", "publishers", "verify-manifest.py", "badge", "feed", "examples", "developer",
    };
